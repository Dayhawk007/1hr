  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center text-primary">
      <div className="w-full max-w-md mx-auto bg-primary shadow-lg rounded-lg p-6">
        <h1 className="text-4xl text-white font-bold mb-6 text-center">1HR CLIENT</h1>
        <div className="mb-4">
        ...
        <button
          onClick={handleLogin}
          className="w-full bg-white text-primary px-4 py-2 rounded-xl shadow-lg font-bold hover:bg-purple-700 hover:text-white ease-in-out duration-300"
        >
          Login
        </button>
      </div>
