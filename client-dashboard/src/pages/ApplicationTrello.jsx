...
const ShowApplicants = () => {
  ...
  const handleDrop = async (newStatus) => {
    if (draggedApplicant && canMoveCard(user.type, newStatus)) {
      ...
      if (confirmMove) {
        ...
        if (feedbackInput) {
          try {
            ...
            setSuccessMessage(
              `Applicant moved to "${newStatus}" stage successfully.`
            );
      ...
      setWarningMessage(
        "You are not authorized to move applicants to this stage."
      );
                            ...
                            >
                              ...
                              <div className="mt-2">
                                <p className="text-sm text-gray-700">
                                  ...
                                  {(applicant.currentFeedback &&
                                    applicant.currentFeedback.feedbackText) ||
                                    "N/A"}
                                </p>
                              </div>
                            </div>
