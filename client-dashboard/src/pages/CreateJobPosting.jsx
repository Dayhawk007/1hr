...
const JobForm = (props) => {
    ...
    return (
        <form onSubmit={handleSubmit} className="min-h-screen bg-gray-900 flex flex-col items-center justify-center text-white">
            <div className="w-full max-w-6xl mx-auto bg-gray-800 shadow-lg rounded-lg p-6">
                ...
                <div>
                    <label htmlFor="client" className="block text-gray-400 mb-1">
                        Client:
                    </label>
                    <select
                        id="client"
                ...
                <div>
                    <label htmlFor="applicationDeadline" className="block text-gray-400 mb-1">
                ...
                <div>
                    <label htmlFor="compensationStart" className="block text-gray-400 mb-1">
                        Compensation Start:
                    </label>
                    <input
                        type="number"
                ...
                <div>
                    <label htmlFor="compensationEnd" className="block text-gray-400 mb-1">
                        Compensation End:
                    </label>
                    <input
                        type="number"
                ...
                <div>
                    ...
                    {questions.map((question, index) => (
                        <div key={index}>
                            <label htmlFor={`questionText-${index}`} className="block text-gray-400 mb-1">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2 rounded bg-gray-700 text-white focus:outline-none focus:bg-gray-600"
                            />
                            <label htmlFor={`questionType-${index}`} className="block text-gray-400 mb-1">
                                Question Type:
                            </label>
                            <select
                            ...
                            {question.questionType === 'multiple-choice' && (
                                <div className='flex flex-row items-center space-x-4 py-4'>
                                    <label htmlFor={`options-${index}`} className="block text-gray-400 mb-1">
                                        Options:
                                    </label>
